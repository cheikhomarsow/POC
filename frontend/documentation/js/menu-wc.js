                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-edd47f5666920d3dd4a8e498cc7c7d29"' :
                                            ...
                                            <li class="link">
                                                <a href="components/AppNavComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AppNavComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/UserPostComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">UserPostComponent</a>
                                            </li>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/PipesModule.html" data-type="entity-link">PipesModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#pipes-links-module-PipesModule-0c0542880cbe77e45d16d5993e628969"' : 'data-target="#xs-pipes-links-module-PipesModule-0c0542880cbe77e45d16d5993e628969"' }>
                                            <span class="icon ion-md-add"></span>
                                            <span>Pipes</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="pipes-links-module-PipesModule-0c0542880cbe77e45d16d5993e628969"' :
                                            'id="xs-pipes-links-module-PipesModule-0c0542880cbe77e45d16d5993e628969"' }>
                                            <li class="link">
                                                <a href="pipes/UserActivatedPipe.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">UserActivatedPipe</a>
                                            </li>
                                            <li class="link">
                                                <a href="pipes/UserFilterPipe.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">UserFilterPipe</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse" ${ isNormalMode ? 'id="pipes-links"' : 'id="xs-pipes-links"' }>
                                <li class="link">
                                    <a href="pipes/DefaultPipePipe.html" data-type="entity-link">DefaultPipePipe</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
